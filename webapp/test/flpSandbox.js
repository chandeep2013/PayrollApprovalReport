		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#commgcuatpayrollreportui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commgcuatpayrollreportui-display": {
								"semanticObject": "commgcuatpayrollreportui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mgc.uatpayrollreportui",
									"url": sap.ui.require.toUrl("com/mgc/uatpayrollreportui")
								}
							}
						}
					}
